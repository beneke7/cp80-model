...
static Anchor kAnchors[] = {
    ...
    {  84, 0.002108f, 0.08f, 0.3771f, 1.25e-09f, 0.003f, 5.21e+07f, 2.00f, 44.0f, 0.95f, 0.0012f, 0.019f, 2.4f, 0.45f },
    { 108, 0.008433f, 0.062f, 0.6678f, 2.0e-09f, 0.0026f,5.00e+07f, 2.00f, 60.0f, 0.95f, 0.00045f,0.0128f,2.2f,0.45f },
};
